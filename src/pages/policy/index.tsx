  ...
  return (
    ...
    >
      <div className="w-full p-[20px]">
        <p>
          V-Fast Soft built the app as a Free app. This SERVICE is provided by
          V-Fast at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Dino JumpX unless
        ...
        <p>
          ...
          the websites that you visit and are stored on your device
          <span>&#8216;</span>s internal memory.
        </p>
        <p>
        ...
        <p>
          ...
          not hesitate to contact us at contact@vfastsoft.com.
        </p>
      </div>
    </main>
  );
